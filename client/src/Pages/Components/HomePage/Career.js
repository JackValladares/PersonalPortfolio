...
function Career(){
    ...
    const jobs = [
            ...
            [
                ...
                "Coding Afficionado",
                DiTerminal,
                "As a Full Stack Software Engineer at Simplepart LLC since September 2022, I've developed and maintained efficient code using ASP.NET and Vue.js, " +
                "leading developer teams and designing solutions architecture for enterprise-level e-commerce software. Working in an Agile environment, I've optimized MSSQL Server database architecture, " +
                "ensuring quality and consistency. During my time at Everspark Interactive, I managed development teams and actively contributed to projects using technologies like WordPress, Shopify, PHP, and MySQL, " +
                "performing tasks from DNS maintenance to Quality Assurance. My earlier roles include developing a full-featured web application at GNETS of Oconee, quickly adapting to unfamiliar software as a Database Analyst " +
                "at Skilletworks, and handling complex projects as a Database Intern at Georgia College. My diverse work experience reflects a versatile, results-driven approach, and profound understanding of modern development practices. " +
                "Whether leading teams, optimizing databases, or creating web applications, my career has been marked by quality and innovation. Here is a list of positions I've been in:",
                ["SimplePart LLC, Full-Stack Developer, September 2022 - Present",
                "Project Manager/Frontend Developer, Everspark Interactive, April 2022 – September 2022",
                "Web Developer, GNETS of Oconee, January 2021 – July 2022",
                "Database Analyst, Skilletworks, September 2020 – June 2021",
                "Database Intern, Georgia College, April 2019 – August 2019"],
                [],
                "April 2019 - Present"
            ],
